...
# 2 load your connectivity matrices
load(file="/mnt/wwn-0x5000c500a8d29c86-part2/IREC/PhD/D/Docs/Sonia/0_PhD/1_Cap1/1_WIP/1_scripts/script_github/connectivityMatrices.Rdata")


# 3 load lee and lee.mc modified functions
...
# Global L p-values after monte carlo permutation
